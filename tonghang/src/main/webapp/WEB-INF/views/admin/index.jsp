...
<link href="${ctx}/common/plugins/fancybox/jquery.fancybox.css"
  rel="stylesheet">
<link href="${ctx}/common/plugins/fullcalendar/fullcalendar.css"
  rel="stylesheet">
<link href="${ctx}/common/plugins/xcharts/xcharts.min.css"
  rel="stylesheet">
...
<body>
          ...
          <div class="row">
            ...
            <div class="col-xs-4 col-sm-8 top-panel-right">
              <ul class="nav navbar-nav pull-right panel-menu">
                ...
                <li class="hidden-xs"><a class="ajax-link" href="#">
                    <i class="fa fa-calendar"></i> <span class="badge">7</span>
                </a></li>
                <li class="hidden-xs"><a href="#" class="ajax-link">
                    <i class="fa fa-envelope"></i> <span class="badge">7</span>
                </a></li>
                <li class="dropdown"><a href="#"
                  class="dropdown-toggle account" data-toggle="dropdown">
                    <div class="avatar">
                      <img src="${ctx}/common/img/admin/avatar.jpg"
                        class="img-rounded" alt="avatar" />
                    </div> <i class="fa fa-angle-down pull-right"></i>
                    <div class="user-mini pull-right">
                      <span class="welcome">Welcome,</span> <span>user1</span>
                    </div>
                </a>
      ...
      <div id="sidebar-left" class="col-xs-2 col-sm-2">
        <ul class="nav main-menu">
          <li class="dropdown"><a href="#" class="dropdown-toggle">
              <i class="fa fa-table"></i> <span class="hidden-xs">审核</span>
          </a>
            <ul class="dropdown-menu">
              <li><a class="ajax-link" href="index_info">信息审核</a></li>
            </ul></li>
          <li class="dropdown"><a href="#" class="dropdown-toggle">
              <i class="fa fa-table"></i> <span class="hidden-xs">管理</span>
          </a>
            <ul class="dropdown-menu">
          ...
          <li class="dropdown"><a href="#" class="dropdown-toggle">
              <i class="fa fa-table"></i> <span class="hidden-xs">资讯</span>
          </a>
            <ul class="dropdown-menu">
              <li><a class="ajax-link" href="articles_info">文章管理</a></li>
              <li><a class="ajax-link" href="banners_info">banner管理</a></li>
            </ul></li>
          <li class="dropdown"><a href="#" class="dropdown-toggle">
              <i class="fa fa-table"></i> <span class="hidden-xs">统计</span>
          </a>
            <ul class="dropdown-menu">
              <li><a class="ajax-link" href="user_increase_info">用户增长</a></li>
              <li><a class="ajax-link"
                href="user_distribution_info">用户分布</a></li>
            </ul></li>
          <li class="dropdown"><a href="#" class="dropdown-toggle">
              <i class="fa fa-table"></i> <span class="hidden-xs">账户</span>
          </a>
            <ul class="dropdown-menu">
              <li><a class="ajax-link" href="admin_user_info">后台账户管理</a></li>
            </ul></li>
          <li class="dropdown"><a href="#" class="dropdown-toggle">
              <i class="fa fa-table"></i> <span class="hidden-xs">权限</span>
          </a>
            <ul class="dropdown-menu">
  ...
  <script
    src="${ctx}/common/plugins/justified-gallery/jquery.justifiedgallery.min.js"></script>
  ...
  <script type="text/javascript" charset="utf-8" src="${ctx}/common/plugins/ueditor/ueditor.config.js"></script>
  <script type="text/javascript" charset="utf-8" src="${ctx}/common/plugins/ueditor/ueditor.all.js"></script>
  <!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
  <!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
  <script type="text/javascript" charset="utf-8" src="${ctx}/common/plugins/ueditor/lang/zh-cn/zh-cn.js"></script>
</body>
</html>
